...
elif [ ${NUMERO_AMBIENTE} == "2" ] || [ ${NUMERO_AMBIENTE} == "3" ] || [ ${NUMERO_AMBIENTE} == "4" ] || [ ${NUMERO_AMBIENTE} == "5" ] || [ ${NUMERO_AMBIENTE} == "6" ] || [ ${NUMERO_AMBIENTE} == "7" ] || [ ${NUMERO_AMBIENTE} == "8" ];
then
...
cp -rf /desa/apps/was/ears/fnetcore_d.ear/html /desa/apps/was/ears/${AMBIENTE_DESA_EAR}.ear/ >> ${ARCHIVO_LOGS} 2>&1
